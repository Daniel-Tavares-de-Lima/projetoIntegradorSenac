                ...
                <section className={casosStyles.content}>
                    {!mostrarCadastro ? (
                        ...
                        <>
                            ...
                            <div className={pacientesStyles.filtroData}>
                                <div className={pacientesStyles.dataField}>
                                    ...
                                    <input type="date" placeholder="DD/MM/AAAA" className={pacientesStyles.dataInput} />
                                </div>
                            ...
                            <input type="search" placeholder="Pesquisar casos, pacientes ou evidência" className={casosStyles.pesquisa} />
                                ...
                                <table>
                                    ...
                                    <tbody>
                                        <tr>
                                            ...
                                            <td>
                                                <span className={pacientesStyles.statusEmAndamento}>Em andamento</span>
                                            </td>
                                        ...
                                        <tr>
                                            ...
                                            <td>
                                                <span className={pacientesStyles.statusArquivado}>Arquivado</span>
                                            </td>
                                            <td className={casosStyles.acoes}>
                                                <button className={casosStyles.acaoBotao} title="Confirmar">✅</button>
                                                <button className={casosStyles.acaoBotao} title="Editar">✏️</button>
                        ...
                        <>
                            ...
                            <div className={casosStyles.section}>
                                <form className={casosStyles.cadastroCasos} onSubmit={(e) => e.preventDefault()}>
